...
public sealed partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        AppWindow.Resize(new SizeInt32(1150, 720));   // 默认窗口尺寸，避免侧栏 + 大卡片放不下
    ...
    private void Nav_SelectionChanged(NavigationView sender, NavigationViewSelectionChangedEventArgs args)
    {
        ...
        if (tag == "manage")
        {
            // 把当前点名班级传给管理页，让它默认选中，避免误覆盖 / 误删别的班
            RootFrame.Navigate(typeof(ManagePage), _currentClassId);
        }
        else if (tag == "about")
        {
            ShowAbout();
    ...
    private async void ShowAbout()
    {
        ...
        panel.Children.Add(new TextBlock { Text = "Made by XU" });
